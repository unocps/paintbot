...
def update_dest(msg):
    ...
    rospy.loginfo('DEBUG: Waiting for move_base server...')
    client.wait_for_server()

    goal = MoveBaseGoal()
    goal.target_pose.header.from_id = 'odom'
    ...
    rospy.loginfo('DEBUG: Sending goal...')
    client.send_goal(goal)
    rospy.loginfo('DEBUG: Waiting for result...')
    wait = client.wait_for_result()
    rospy.loginfo('DEBUG: Getting result...')
    result = client.get_result()
    rospy.loginfo('DEBUG: move_base client result: {}'.format(result))
